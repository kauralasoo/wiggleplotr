...
```
Finally, we can extract exon and coding sequence (CDS) coordinates for all annotated transcripts from the database. This command will produce a a list of [GRanges] objects, each element containing the exons of a single transcript.
```{rm, eval=FALSE}
